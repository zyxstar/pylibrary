...
_magic_number = 6
_modified_time = 1333679330.5150001
_template_filename='F:/eclipsWorkSpace/pylibrary/tmpl/borrow/giveback.html'
_template_uri='giveback.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n')
        # SOURCE LINE 9
        runtime._include_file(context, u'giveback_1.html', _template_uri)
        __M_writer(u'\r\n')
        # SOURCE LINE 10
        ...
        __M_writer(u'\r\n')
        # SOURCE LINE 13
        __M_writer(unicode(self.js('lib/PanelBook2.js')))
        __M_writer(u'\r\n\r\n')
        # SOURCE LINE 15
        runtime._include_file(context, u'giveback_0.html', _template_uri)
        return ''
    finally:
